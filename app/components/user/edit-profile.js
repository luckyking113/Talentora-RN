...
class EditProfile extends Component {
    ...
    constructor(props){
        ...
        this.state = {
            ...
            age:{
                val:Helper._getAgeByYear(UserHelper.UserInfo.profile.attributes.date_of_birth.value)
            },
            gender: {  
    ...
    Update(){
        ...
        console.log("Talent Category Totally",this.state.talent_cate);
        ...
        if(UserHelper._isUser()){
            allField=_.extend({
                ...
                "hair_color": {
                    "value": this.state.myhaircolor.val,
                    "privacy_type": "only-me"
                },
                "eye_color": {
                    "value": this.state.myeyecolor.val,
                    "privacy_type": "only-me"
                },              
            },allField)
        }
                    ...
                    <View> 
                        ...
                        <TouchableOpacity
                            ...
                            <View style = {styles.itemPicker}>
                                {
                                    type == 'ethnicity' && 
                                    <Text style={[ styles.flatInputBoxFont, {textAlign:'right',color: this.state.selectedEthnicity ? 'black':'#9B9B9B'}]}>{ this.state.selectedEthnicity || 'Select ethnicity' }</Text>
                                }

                                {
                                    type == 'hair' && 
                                    <Text style={[ styles.flatInputBoxFont, {textAlign:'right',color: this.state.myhaircolor.val ? 'black':'#9B9B9B'}]}>{ this.state.myhaircolor.val || 'Select hair color' }</Text>
                                }

                                {
                                    type == 'eye' && 
                                    <Text style={[ styles.flatInputBoxFont, {textAlign:'right',color: this.state.myeyecolor ? 'black':'#9B9B9B'}]}>{ this.state.myeyecolor.val || 'Select eye color' }</Text>
                                }
                            </View>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={[styles.mainPadding]}>
                        ...
                        <View style={[ styles.justFlexContainer ]}>
                            <View style={[{marginVertical:20,}]}>
                                ...
                                <VideoUploadEditProfile navigation={this.props.navigation} />
                        ...
                        <View style={[{marginVertical:10}]}>
                            <Text style={[{fontSize:15,fontWeight:'bold'}]}>What talent are you?</Text>
                        ...
                        <View style={[{flex:1}]}>
                            <TouchableOpacity style={[{flex:1,flexDirection:'row',alignItems:'center',justifyContent:'center'}]} activeOpacity = {0.9} onPress={(event) => { this.refs.FirstInput.focus();}}>
                                <Text style={[styles.titleBold,{flex:0.3}]}>First Name</Text>
                                <TextInput 
                                    ref='FirstInput' 
                        ...
                        <View style={[{flex:1}]}>
                            <TouchableOpacity style={[{flex:1,flexDirection:'row',alignItems:'center',justifyContent:'center'}]} activeOpacity = {0.9} onPress={(event) => { this.refs.SecondInput.focus();}}>
                                <Text style={[styles.titleBold,{flex:0.3}]}>Last Name</Text>
                                <TextInput 
                                    ref='SecondInput'
                                        ...
                                        <Modal
                                            ...
                                            <View onPress = {()=>{ }} style={{flex: 1, justifyContent: 'flex-end',marginTop: 22}}>
                                                <TouchableOpacity
                                                    ...
                                                    onPress={() => {
                                                        this.setModalVisible(!this.state.genderModalVisible)
                                                    }}>
                                                    <Text style={[styles.fontBold, {textAlign: 'right', color: '#3b5998'} ]} >Done</Text>
                                                </TouchableOpacity>
                                                <View style={[ {backgroundColor: 'white'} ]}>
                            ...
                            <View>
                                ...
                                <View style={[{flex:1}]}>
                                    <TouchableOpacity style={[{flex:1,flexDirection:'row',alignItems:'center',justifyContent:'center'}]} activeOpacity = {0.9} onPress={() => this.setModalVisible(true, 'language')}>
                                        ...
                                        <View style = {styles.itemPicker}>
                                            <Text style={[ styles.flatInputBoxFont, {color: this.state.displayLanguages ? '#4a4a4a':'#9B9B9B'}]}>{ this.state.displayLanguages || 'Select languages' }</Text>
                                        </View>
                                    </TouchableOpacity>
                        ...
                        {UserHelper._isEmployer() &&
                            <View style={[{flex:1}]}>
                                <TouchableOpacity style={[{flex:1,flexDirection:'row',alignItems:'center',justifyContent:'center'}]} activeOpacity = {0.9} onPress={(event) => { this.refs.NinethInput.focus();}}>
                                    <Text style={[styles.titleBold,{flex:0.3}]}>Company</Text>
                                    <TextInput 
                                        ref='NinethInput'
