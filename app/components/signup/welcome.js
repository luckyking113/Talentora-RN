...
import {
  StyleSheet, Text, View, TextInput, TouchableOpacity, Alert, StatusBar, Picker,
  Modal, ActivityIndicator, ScrollView, Keyboard, KeyboardAvoidingView, TouchableWithoutFeedback, Platform
} from 'react-native';
          ...
          <KeyboardAvoidingView
            ...
            <TouchableWithoutFeedback onPress={() => { dismissKeyboard() }} style={[styles.container]}>
              <View style={[styles.mainPadding]}>
                ...
                <TextInput
                  onChangeText={(txtFirstname) => this.setState({
                    firstname: {
                ...
                <TextInput
                  onChangeText={(txtLastname) => this.setState({
                    lastname: {
                ...
                {this._checkTalentType('employer') &&
                  <TextInput
                    onChangeText={(txtCompany) => this.setState({
                      company: {
                        val: txtCompany
                      }
                    })}
